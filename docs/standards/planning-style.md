...
This is the single canonical copy for this project, shared across planning docs
and `.changelog`. Do not fork per-domain variants; cite this file.
...
- Keep human-edited working roadmap definitions in `docs/roadmaps/`. Historical
  hardcopies belong under a `_legacy/` directory; do not hand-maintain
  milestone definitions there.
- Keep top-level docs stable. `README.md`, `AGENTS.md`, and durable docs should
  point to canonical directories, not individual dated plans.
...
- Move dated plans and dated source reports to `_legacy/` if one exists, or
  delete them. Keep the durable rules promoted into the owning docs.
